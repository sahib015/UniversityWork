 ...
 */
public class AllocateReviewers  extends JFrame{
    ...
    private void populateMainPanel() {
        ArrayList<AREmployee> values = ReviewController.getData();// need to create method to get the reviewers
